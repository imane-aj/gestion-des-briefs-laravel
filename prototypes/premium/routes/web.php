...
Route::resource('/student', StudentController::class)->except('student.create');
Route::get('/promotion/{token}/student', [StudentController::class, 'create'])->name('student.create');
